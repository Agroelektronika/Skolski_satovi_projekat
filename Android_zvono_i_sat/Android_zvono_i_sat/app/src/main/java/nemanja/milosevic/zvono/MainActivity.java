...
// u Main Activity se vrsi login, samo prvi put, jednom kad se uloguje, automatski se vrsi svaki sledeci put kad se upali aplikacija
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // EdgeToEdge.enable(this);
        ...
        String logovan = ucitaj_iz_memorije("logovan");
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(username.equals("admin") && password.equals("jswomvjknmc")){
                    upisi_u_memoriju("sifra", sifra);
                    ulogovan = true;
                    upisi_u_memoriju("logovan", String.valueOf(ulogovan));
                    Intent i = new Intent(MainActivity.this, HomeActivity.class);
                    startActivity(i);
                }
                else{
